package com.wxk.gmall.order.controller;
...
public class OrderController {
    ...
    @LoginRequired
    public String checkCart(HttpServletRequest request, HttpServletResponse response, HttpSession session, ModelMap modelMap) {

        String memberId = (String)request.getAttribute("memberId");
        String nickname = (String)request.getAttribute("nickname");
        //null.toString()   ==> 空指针异常

        //购物车集合   转化为结算清单+收货地址列表
