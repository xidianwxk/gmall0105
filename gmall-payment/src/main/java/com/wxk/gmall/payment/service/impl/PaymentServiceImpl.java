package com.wxk.gmall.payment.service.impl;
...
import com.wxk.gmall.payment.mapper.PaymentInfoMapper;
...
public class PaymentServiceImpl implements PaymentService  {
    ...
    public void sendDelayPaymentResultCheckQueue(String outTradeNo, Integer count) {
        ...
        try{
            ...
            // 为消息加入延迟时间
            mapMessage.setLongProperty(ScheduledMessage.AMQ_SCHEDULED_DELAY,1000*60);//30秒
