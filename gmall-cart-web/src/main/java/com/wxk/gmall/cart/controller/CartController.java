package com.wxk.gmall.cart.controller;
...
import com.wxk.gmall.util.CookieUtil;
    ...
    public String addToCart(String skuId, int quantity, HttpServletRequest request, HttpServletResponse response, HttpSession session) {
       ...
       // String memberId = "1";//"1";    request.getAttribute("memberId");
        ...
        if (StringUtils.isBlank(memberId)) {
            ...
            // cookie里原有的购物车数据
            String cartListCookie = CookieUtil.getCookieValue(request, "cartListCookie", true);
            String a = "["+cartListCookie.substring(1,cartListCookie.length()-1)+"]";
            System.out.println("a::"+a);
            cartListCookie = a;
            System.out.println("cartListCookie:::"+cartListCookie);
            System.out.println(cartListCookie.charAt(cartListCookie.length()-1));
