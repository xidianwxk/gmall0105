package com.wxk.gmall.user.service.Impl;
...
import com.wxk.gmall.user.mapper.UmsMemberReceiveAddressMapper;
import com.wxk.gmall.user.mapper.UserMapper;
...
//        umsMemberReceiveAddressMapper.selectByExample(e);
        ...
        //与上面一样。where(...)
//        Example e = new Example(UmsMemberReceiveAddress.class);  //获得泛型
//        e.createCriteria().andEqualTo("memberId",memberId);   //过滤条件
